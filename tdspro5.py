...
def _delay(value):
	while not(value <= 1):
		value -= 0.123
		print(f'''\033[1;39m[\033[1;36QM-TOOL\033[1;32m][ \033[1;36mDELAY \033[1;35m][\033[1;36m{str(value)[0:5]}\033[1;36m][\033[1;33m|\033[1;39m ]''', '               ', end = '\r')
		sleep(0.010)
		print(f'''\033[1;39m[\033[1;36QM-TOOL\033[1;32m][ \033[1;36mDELAY \033[1;35m][\033[1;36m{str(value)[0:5]}\033[1;36m[\033[1;33m-\033[1;39m]''', '               ', end = '\r')
		sleep(0.010)
		print(f'''\033[1;39m[\033[1;36QM-TOOL\033[1;32m][ \033[1;36mDELAY \033[1;35m][\033[1;36m{str(value)[0:5]}\033[1;36m[\033[1;33m/\033[1;39m]''', '               ', end = '\r')
...
def countdown(value):
	while not(value <= 1) :
		value -= 0.123
		print(f'''\033[1;39m[\033[1;36QM-TOOL\033[1;32m][ \033[1;36mDELAY \033[1;35m][\033[1;36m{str(value)[0:5]}\033[1;39m[\033[1;33mX    \033[1;39m]''', '               ', end = '\r')
		sleep(0.01)
		print(f'''\033[1;39m[\033[1;36QM-TOOL\033[1;32m][ \033[1;36mDELAY \033[1;35m][\033[1;36m{str(value)[0:5]}\033[1;39m[\033[1;33m X   \033[1;39m]''', '               ', end = '\r')
		sleep(0.01)
		print(f'''\033[1;39m[\033[1;36QM-TOOL\033[1;32m][ \033[1;36mDELAY \033[1;35m][\033[1;36m{str(value)[0:5]}\033[1;39m[\033[1;33m  X  \033[1;39m]''', '               ', end = '\r')
		sleep(0.01)
		print(f'''\033[1;39m[\033[1;36QM-TOOL\033[1;32m][ \033[1;36mDELAY \033[1;35m][\033[1;36m{str(value)[0:5]}\033[1;39m[\033[1;33m   X \033[1;39m]''', '               ', end = '\r')
...
def chongblock(delaybl):
	for i in range(delaybl, -1, -1):
		Write.Print(f'\033[1;31mĐang nghỉ chạy, sẽ chạy lại sau {i} giây... \r',interval=0.0001);sleep(1); print('                                                        ', end = '\r')
def _Infofb(cookie):
    heads={
        "accept": "*/*",
